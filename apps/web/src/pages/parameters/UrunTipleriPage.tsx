  ...
  return (
    ...
    >
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {loading ? (
                  ...
                  <tr><td colSpan={4} className="p-8 text-center text-muted-foreground">{error || 'Henüz ürün tipi kaydı yok.'}</td></tr>
                ) : (
                  data.map((item) => (
                    <tr
                      key={item.id}
      ...
      <ConfirmDeleteDialog
        ...
        description="Bu ürün tipini silmek istediğinize emin misiniz?"
